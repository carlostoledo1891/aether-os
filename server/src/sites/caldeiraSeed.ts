/**
 * Caldeira Project — server-side seed data.
 *
 * All domain data for the Caldeira site in one file.
 * Canonical site config (identity, geo, thresholds) lives in shared/sites/caldeira.ts.
 * When a shared-package build pipeline is available, import from there instead.
 *
 * Keys match the domain_state keys used by server/src/routes/domain.ts.
 */

import type { AuditEventInput } from '../store/auditChain.js'

/* ── Thresholds & Fundamental Constants (mirror shared/sites/caldeira.ts) ── */
...
const SPRING_COUNT = 1092

/* ── Domain Seed Data ─────────────────────────────────────────────────────── */

export const CALDEIRA_SEED: Record<string, unknown> = {
  ...
  financial_scenarios: {
    consensus: { key: 'consensus', label: 'Consensus', ndpr_price_kg: 86, dytb_price_kg: 480, npv_pretax_m: 821, npv_posttax_m: 488, irr_pretax_pct: 28, irr_posttax_pct: 21, payback_yrs: 3, annual_revenue_m: 315, opex_per_kg: 8.91, breakeven_ndpr_kg: 22 },
    bull: { key: 'bull', label: 'Bull (Forecast)', ndpr_price_kg: 135, dytb_price_kg: 680, npv_pretax_m: 1985, npv_posttax_m: 1256, irr_pretax_pct: 39, irr_posttax_pct: 31, payback_yrs: 2, annual_revenue_m: 485, opex_per_kg: 8.91, breakeven_ndpr_kg: 22 },
    bear: { key: 'bear', label: 'Bear (Spot)', ndpr_price_kg: 67, dytb_price_kg: 350, npv_pretax_m: 251, npv_posttax_m: 109, irr_pretax_pct: 15, irr_posttax_pct: 11, payback_yrs: 5, annual_revenue_m: 245, opex_per_kg: 8.91, breakeven_ndpr_kg: 22 },
  },
  ...
  pricing_model: {
    ...
    tiers: [
      { name: 'Pilot', price_usd_mo: 2500, includes: '1 project, 5 users, 10k AI queries/mo, standard map tiles, email support', target: 'PFS-stage explorers' },
      { name: 'Growth', price_usd_mo: 8500, includes: '3 projects, 25 users, 50k AI queries/mo, premium map tiles, priority support, API access', target: 'DFS-through-construction operators' },
      { name: 'Enterprise', price_usd_mo: null, includes: 'Unlimited projects/users, custom AI model tuning, SSO/RBAC, dedicated CSM, SLA 99.9%', target: 'Multi-asset operators' },
    ],
    cost_components: [
      ...
      { component: 'Data integration (API + enrichers)', est_mo: 0, notes: 'Included in platform' },
      { component: 'Support & maintenance', est_mo: 500, notes: 'Prorated across customer base' },
    ],
    tco_year1: { pilot_usd: 30000, growth_usd: 102000, enterprise_usd: 'Custom — typically $180k-$350k', note: 'Excludes one-time onboarding ($5k-$15k)' },
  },
  ...
  issuer_snapshot: {
    ...
    resource: { headline: '1.537 Bt @ 2,359 ppm TREO', citation: { date: '2025-07-29', title: 'Updated MRE', url: 'https://meteoric.com.au/asx-announcements/' } },
    pfs: { headline: 'Pre-tax NPV₈ $821M (consensus) | Post-tax $488M', citation: { date: '2025-07-29', title: 'PFS Results', url: 'https://meteoric.com.au/asx-announcements/' } },
  },

  spatial_insights: {
    pilotToPfsPlantKm: 9.6, licenceZonesInApaBuffer: 2,
    summary: 'Pilot plant is ~9.6 km from the PFS commercial plant collar. 2 licence zones intersect the APA buffer.',
  ...
  batches: [
    {
      ...
      molecular_timeline: [
        { step: 'Extraction', description: 'IAC ore excavated — Caldeira Site, Block 14-C', timestamp: '2026-04-05T06:12:00Z', status: 'verified', coordinates: { lat: -21.992, lng: -46.483 }, linked_drills: ['CDMDD0007', 'CDMDD0005', 'CDMDD0008'] },
        ...
        { step: 'Precipitation', description: 'MREC precipitated. Grade >90% TREO, <2% impurity', timestamp: '2026-04-05T14:20:00Z', status: 'verified', coordinates: { lat: -21.797, lng: -46.568 } },
        { step: 'FJH Separation', description: 'Flash Joule Heating separation. 80%+ LREE removal.', timestamp: '2026-04-05T18:30:00Z', status: 'verified', coordinates: { lat: -21.799, lng: -46.570 } },
        { step: 'Quality Assurance', description: 'Inline XRF analysis. TREO grade: 91.4%.', timestamp: '2026-04-05T21:00:00Z', status: 'active', coordinates: { lat: -21.799, lng: -46.570 } },
        { step: 'Export Logistics', description: 'Containerized MREC — Port of Santos, SP.', timestamp: '2026-04-07T08:00:00Z', status: 'pending', coordinates: { lat: -23.960, lng: -46.333 } },
        { step: 'Ucore SMC Delivery', description: 'Louisiana Strategic Metals Complex — US DoD supply chain.', timestamp: '2026-04-14T12:00:00Z', status: 'pending', coordinates: { lat: 30.391, lng: -91.028 } },
      ],
    ...
    },
    {
      ...
      molecular_timeline: [
        ...
        { step: 'EU DBP Issued', description: 'Digital Battery Passport issued. Catena-X registered.', timestamp: '2026-04-06T00:00:00Z', status: 'verified', coordinates: { lat: 59.437, lng: 24.754 } },
      ],
    ...
    },
    {
      ...
      molecular_timeline: [
        ...
        { step: 'Quality Certified', description: 'Inline XRF + ICP-MS analysis.', timestamp: '2026-03-11T10:00:00Z', status: 'verified', coordinates: { lat: -21.08, lng: -46.43 } },
        { step: 'Export Cleared', description: 'Santos Port — export documentation cleared.', timestamp: '2026-03-12T06:00:00Z', status: 'verified', coordinates: { lat: -23.95, lng: -46.33 } },
        ...
        { step: 'ETA Destination', description: 'Shin-Etsu Chemical — Takefu, Japan.', timestamp: '2026-04-28T00:00:00Z', status: 'pending', coordinates: { lat: 35.90, lng: 136.17 } },
      ],
    ...
    },
    {
      ...
      molecular_timeline: [
        ...
        { step: 'Export Cleared', description: 'Santos Port — export cleared.', timestamp: '2026-02-05T06:00:00Z', status: 'verified', coordinates: { lat: -23.95, lng: -46.33 } },
        { step: 'Customs Cleared', description: 'Long Beach, CA — US customs clearance.', timestamp: '2026-02-20T12:00:00Z', status: 'verified', coordinates: { lat: 33.76, lng: -118.19 } },
        { step: 'Delivered', description: 'MP Materials — Mountain Pass, NV.', timestamp: '2026-02-28T14:00:00Z', status: 'verified', coordinates: { lat: 35.47, lng: -115.53 } },
      ],
  ...
  esg_frameworks: [
    ...
    { id: 'issb-s2', name: 'ISSB S2: Climate Disclosures', standard: 'ISSB', category: 'climate', coverage_pct: 62, metrics: [
      { metric: 'Physical climate risk assessment', dashboardSource: 'FieldView → Hydro Twin → Drought Forecast', status: 'mapped' },
      ...
      { metric: 'Financed emissions', dashboardSource: 'Not yet tracked', status: 'pending' },
    ] },
  ],
  ...
  deposit_data: [
    ...
    { id: 'soberbo', name: 'Soberbo', status: 'indicated', treo_ppm: 2601, mreo_pct: 26, tonnage_mt: 229, clay_depth_avg_m: 16.9, clay_depth_max_m: 77.4, area_km2: 9.9, dimensions: '2,600 × 3,800 m', orientation: 'NE-SW', resource_note: 'Highest-grade hub.', center: [-46.615, -21.882] },
    ...
    { id: 'barra-do-pacu', name: 'Barra do Pacu', status: 'indicated', treo_ppm: 2204, mreo_pct: 22, tonnage_mt: 389, clay_depth_avg_m: 29.2, clay_depth_max_m: 50, area_km2: 7.6, dimensions: '1,900 × 4,000 m', orientation: 'N-S', resource_note: 'Maiden resource Apr 2025.', center: [-46.555, -21.878] },
    ...
    { id: 'cupim-vermelho-norte', name: 'Cupim Vermelho Norte', status: 'inferred', treo_ppm: 2200, mreo_pct: 24, tonnage_mt: 340, clay_depth_avg_m: 20, clay_depth_max_m: 55, area_km2: 13.0, dimensions: '2,600 × 5,000 m', orientation: 'NW-SE', resource_note: 'Largest resource block.', center: [-46.5855, -21.7229] },
  ...
  scale_up_pathway: {
    ...
    water_recirculation_target_pct: 95, springs_monitored: SPRING_COUNT,
  ...
  hardware_sensors: [
    { category: 'Core Process Sensors', items: [
      { name: 'Ultrasonic Flow Meters', location: 'Water intake/outflow pipes', measures: '95% water recirculation', frequency: '2s' },
      { name: 'Industrial pH & ORP Probes', location: 'Leaching vats', measures: 'pH 4.0–5.0 maintenance', frequency: '2s' },
  ...
  cyber_pillars: [
    { title: 'Zero-Trust Edge Gateways', detail: 'IoT gateways utilize hardware-based TEEs to encrypt data at the sensor array.', status: 'Active', protocol: 'TEE + mTLS' },
    ...
    { title: 'SOC 2 Type II Compliance', detail: 'Continuous automated auditing for data security, availability, and processing integrity.', status: 'Compliant', protocol: 'Automated audit trail' },
  ...
  api_handoffs: [
    ...
    { system: 'Board Audit Vault', endpoint: 'GET /v1/audit/caldeira-risk-room', payload: 'Permit pack + hydrology scenarios + immutable event log', status: 'verified', latency_ms: 180, last_sync: '2026-04-06T03:18:40Z' },
  ],
  ...
  stakeholder_register: {
    groups: [
      { group: 'Community', status: 'neutral', summary: 'Engagement active, LAPOC pending', items: [
      ...
      { group: 'Regulatory', status: 'neutral', summary: 'Mixed agency posture', items: [
      ...
      { group: 'Commercial', status: 'positive', summary: 'Pipeline active', items: [
      ...
      { group: 'ESG & Media', status: 'positive', summary: 'Readiness high', items: [
...
/* ── Audit Events (seeded in chronological order for correct chaining) ── */

export const CALDEIRA_AUDIT_SEED: AuditEventInput[] = [
  { event_id: 'AUD-015', timestamp: '2026-03-15T10:00:00Z', type: 'batch_created' as const, actor: 'A. Lima (Operations)', action: 'Batch BATCH-MREC-7W2 initiated', detail: 'MREC precipitation run started. Feed material from Soberbo pit.', relatedEntityId: 'BATCH-MREC-7W2' },
  { event_id: 'AUD-014', timestamp: '2026-03-20T15:00:00Z', type: 'offtake_update' as const, actor: 'VP Commercial', action: 'Neo Performance LOI executed', detail: 'LOI signed for 1,500 tpa TREO.', relatedEntityId: 'neo' },
  { event_id: 'AUD-013', timestamp: '2026-03-25T08:33:00Z', type: 'user_action' as const, actor: 'Dr. L. Oliveira (Hydro.)', action: 'Pumping throttle applied — PIZ-E04', detail: 'Seasonal drawdown event. Pumping reduced 20%.' },
  { event_id: 'AUD-012', timestamp: '2026-03-28T12:20:00Z', type: 'alert_resolved' as const, actor: 'R. Ferreira (HSE)', action: 'UDC radiation event resolved', detail: 'Wind-carried particulate event. Levels normalized after 75 min.' },
  { event_id: 'AUD-011', timestamp: '2026-04-01T09:00:00Z', type: 'compliance_check' as const, actor: 'System', action: 'SOC 2 Type II automated audit cycle', detail: 'Continuous compliance checks passed. 0 findings.' },
