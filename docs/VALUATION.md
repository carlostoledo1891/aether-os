...
| Traction (Meteoric anchor, NIST-mapped, digital twin) | 10% | 3.5 | 0.35 |
...
"Vero is vertical SaaS for critical mineral operators and their stakeholders. TAM $18.8B growing 11%. SAM $1.6B in compliance/traceability SaaS growing 14%, driven by EU Battery Passport (hard enforcement Feb 2027) and US FEOC requirements. We're not pre-product — production-grade platform with NIST 800-53 controls mapped, named anchor relationship, and a pilot plant digital twin running live telemetry. The founder grew up inside the flagship deposit. Pre-money $5–7M consensus for a seed that buys 18 months of runway, a commercial hire, and 5 paid pilots."
