...
5. **Update AGENT.md** — at the end of every session, record what was done, what is in progress, and what comes next.
...
- **Flag technical debt immediately.** If a shortcut is taken, document it in AGENT.md under Known Issues.
...
[ ] AGENT.md updated           — if session is ending
```
