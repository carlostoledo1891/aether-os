...
import envelopeUrl from '../geojson/caldeira-licence-envelope.geojson?url'
import neighborsUrl from '../geojson/caldeira-neighbors.geojson?url'
import depositsUrl from '../geojson/caldeira-deposits.geojson?url'
...
import routesUrl from '../geojson/caldeira-access-routes.geojson?url'
...
import plantEdgesUrl from '../geojson/plant-edges.geojson?url'
import plantNodesUrl from '../geojson/plant-nodes.geojson?url'
...
export const GEO = {
  ...
  envelope:      { id: 'caldeira-licence-envelope',  url: envelopeUrl,     kind: 'polygon' as const, renderOrder: 1 },
  neighbors:     { id: 'caldeira-neighbors',         url: neighborsUrl,    kind: 'polygon' as const, renderOrder: 2 },
  deposits:      { id: 'caldeira-deposits',          url: depositsUrl,     kind: 'polygon' as const, renderOrder: 3 },
  ...
  routes:        { id: 'caldeira-access-routes',     url: routesUrl,       kind: 'line'    as const, renderOrder: 20 },
  plantEdges:    { id: 'plant-edges',                url: plantEdgesUrl,   kind: 'line'    as const, renderOrder: 21 },
  ...
  plantNodes:    { id: 'plant-nodes',                url: plantNodesUrl,   kind: 'point'   as const, renderOrder: 35 },
