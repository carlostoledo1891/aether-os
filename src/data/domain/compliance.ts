...
export const AUDIT_TRAIL: AuditEvent[] = [
  { id: 'AUD-001', timestamp: '2026-04-06T08:00:00Z', type: 'system_event', actor: 'System', action: 'VeroChain instance started', detail: 'Production environment boot — all sensor feeds connected. Firmware v2.4.1.', hash: sha256Stub('AUD-001-system-start') },
  ...
  { id: 'AUD-006', timestamp: '2026-04-04T10:00:00Z', type: 'passport_issued', actor: 'VeroChain', action: 'Digital Battery Passport DBP-2026-0042 issued', detail: 'EU-compliant DBP JSON payload generated for batch BATCH-MREC-7W2. Hash anchored to permissioned ledger.', hash: sha256Stub('AUD-006-dbp-issue'), relatedEntityId: 'BATCH-MREC-7W2' },
  { id: 'AUD-007', timestamp: '2026-04-04T10:05:00Z', type: 'api_handoff', actor: 'VeroChain', action: 'DBP payload pushed to Ucore SAP', detail: 'Automated ABI pre-filing to US CBP. Digital Battery Passport synchronized to Ucore ERP via REST API. HTTP 200.', hash: sha256Stub('AUD-007-api-push'), relatedEntityId: 'ucore' },
  ...
  { id: 'AUD-012', timestamp: '2026-03-28T12:20:00Z', type: 'alert_resolved', actor: 'R. Ferreira (HSE)', action: 'UDC radiation event resolved', detail: 'Wind-carried particulate event. Personnel evacuated from 500m zone. Levels normalized after 75 min. ANSN incident form filed.', hash: sha256Stub('AUD-012-radiation-resolve') },
