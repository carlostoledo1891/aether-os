...
export default function WhiteBoxSlide() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', height: '100%', justifyContent: 'center', width: '100%', maxWidth: 1080, margin: '0 auto', gap: 60 }}>
      {/* Left Column: Content */}
      <div style={{ display: 'flex', flexDirection: 'column', flex: 1, textAlign: 'left' }}>
        ...
        <div style={{ marginTop: 24, padding: '16px 20px', background: `${V}10`, border: `1px solid ${V}30`, borderRadius: 12, maxWidth: 600 }}>
          <p style={{ fontSize: 13, color: W.text2, margin: 0, textAlign: 'left', fontWeight: 500 }}>
      ...
      <div style={{ flex: '0 0 400px', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', minHeight: 600 }}>
