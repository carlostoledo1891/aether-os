...
export default function DataServiceSlide() {
  return (<>
    ...
    <svg viewBox="0 0 820 280" style={{ maxWidth: 940, width: '100%', overflow: 'visible' }}>
      ...
      <text x="100" y="60" textAnchor="middle" fill={W.text3} fontSize="9">Operations · Executive · Trade</text>
      ...
      <text x="320" y="60" textAnchor="middle" fill={W.text3} fontSize="9">Hook · dedup cache</text>
      ...
      <text x="380" y="148" textAnchor="middle" fill={W.text3} fontSize="9">MaybeAsync{'<T>'} · 40+ methods</text>
      ...
      <text x="210" y="238" textAnchor="middle" fill={W.text3} fontSize="9">Returns T · in-memory</text>
      <line x1="320" y1="162" x2="260" y2="196" stroke={`${V}40`} strokeWidth="1" strokeDasharray="4 2" />
      <text x="270" y="178" fill={W.text3} fontSize="8" fontFamily="var(--font-mono)">implements</text>
      ...
      <text x="550" y="238" textAnchor="middle" fill={W.text3} fontSize="9">{'Promise<T>'} · fetch + WS</text>
      <line x1="440" y1="162" x2="500" y2="196" stroke={`${V}40`} strokeWidth="1" strokeDasharray="4 2" />
      <text x="490" y="178" fill={W.text3} fontSize="8" fontFamily="var(--font-mono)">implements</text>
      ...
      <text x="380" y="274" textAnchor="middle" fontSize="10" fontFamily="var(--font-mono)">
        <tspan fill={W.text3}>Swap implementation </tspan>
        <tspan fill={V}>→</tspan>
        <tspan fill={W.text3}> zero frontend changes</tspan>
      </text>
    </svg>
  </>)
}
